...
//import edu.kh.oop.cls.model.vo.TsstVo;
//The import edu.kh.oop.cls.model.vo.TsstVo cannot be resolved
public class ClsService extends Student {
	...
	public void ex2() {
		...
		// 정보 출력
		System.out.println(std1.schoolName); // public 이기 떄문에 직접 접근 가능
		 ...
		 * 그리고,static 영역에 생성된 변수는 어디서든 지 공유 가능(공유)
		 * 
		 * 2) 사용방법 ; 클래스명.변수명
		 * 
		 **/
	...
	public void ex3() {
		...
		System.out.println("--------------------");
		//해결 방법: setter를 이용해서 새로운 값 대입
		
		u2.setUserId("asd58151");
		u2.setUserPw("58151");
		u2.setUserName("김영희");
		u2.setUserAge(10);
		u2.setUserGender('여');
